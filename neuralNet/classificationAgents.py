...
class ClassifierAgent(Agent):
    def __init__(self, trainingData=None, validationData=None, classifierType="perceptron", agentToClone=None, numTraining=3):
        from dataClassifier import runClassifier, basicFeatureExtractorPacman, enhancedFeatureExtractorPacman
    ...
    def getAction(self, state):
        from dataClassifier import runClassifier, enhancedFeatureExtractorPacman, enhancedFeatureExtractorPacman
